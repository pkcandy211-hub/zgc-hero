...
export const COMMANDANTS: Commandant[] = [
  {
    ...
    specialEquip: "金錵筩",
    specialFeature: "千機",
    specialFeatureDesc: "周劭裝備時，【流雲千變】必定穩定執行 2 次。",
  ...
  },
  {
    ...
    recommendedTeams: [
      "【騎兵】賈詡 + 荀攸 + 楊琪 (雙主動戰法陣容，配合楊琪自帶戰法的戰鬥屬性提升，賈詡作為隊伍主力輸出和控制)",
      "【盾兵】張角 + 楊琪 + 左慈"
    ],
    recommendedClass: "諸葛亮、曹操、司馬懿、陸遜 等高智力武將",
  ...
  },
  {
    ...
    recommendedTeams: [
      "【弓兵】SP盧植 + 蕭芷 + SP貂蟬 (蕭芷可穩定奪取敵方兵力，更容易讓SP貂蟬造成溢出治療並造成謀略傷害！)",
    ],
    recommendedClass: "拜師推薦司馬懿、周瑜、曹操、諸葛亮",
  ...
  },
  {
    ...
    skillName: "劍拔弩張",
    skillRate: "100%",
    skillDescription: "戰鬥中，友軍受到傷害時有70%機率（受智力影響）對敵軍單體造成一次傷害（傷害率70%，類型受武力智力較高一項影響），每名武將每回合可觸發3次；自身行動時，若我軍統率最高單體處於控制狀態，使其對敵軍全體造成傷害（傷害率108%，類型受武力智力較高一項影響）。",
    specialEquip: "龍方壺",
    specialFeature: "鋒鳴",
    specialFeatureDesc: "陳翊裝備時，【劍拔弩張】每回合觸發次數上限提升至 4 次。",
    equipBonus: "統率 +5.00, 智力 +5.00",
    analysis: "更建議全智力加點，剋制有穩定控制的隊伍。具備極強的被動反擊傷害與解控爆發能力。在統率型肉盾被控制時，能藉由自身行動回合觸發高額的全體群攻爆發，十分契合桃園或配合「高朋滿座」武鋒等防守體系。",
    recommendedTeams: [
      "【盾兵】SP關羽 + 陳翊 + 張飛 (配合「高朋滿座」天賦，啟動桃園和五虎緣分，來加大陳翊自帶戰法的傷害)"
    ],
    recommendedClass: "推薦拜師高智力武將，如姜維、諸葛亮",
  ...
  },
  {
    ...
    recommendedTeams: [
      "【盾兵】SP關羽 + 皇甫宏 + SP法正 (皇甫宏自帶戰法提供的嘲諷和治療，搭配魅惑，具有極強的控制和承傷能力，確保SP關羽的生存和後續輸出)"
    ],
  ...
  },
  {
    ...
    equipBonus: "統率 +5.00, 速度 +5.00",
    analysis: "驚人的全場屬性壓制與控制中斷器。對抗快攻及特技隊伍有不可多得的消減能力。契合持續作戰的毒流或拉鋸隊。",
    recommendedTeams: [
      "【弓兵】許攸 + 柳沁 + 呂布",
      "【弓兵】甘寧 + 太史慈 + 柳沁 (柳沁降低敵方屬性，獨特恐懼效果，配合摧鋒斷刃與錦帆軍，適合長回合陣容)"
    ],
    recommendedClass: "諸葛亮、曹操、司馬懿",
  ...
  },
  {
    ...
    skillName: "緩兵之計",
    skillRate: "70%",
    skillDescription: "對敵我全體隨機武將施加 1 次抵禦，共執行 4 次。被施加目標：若目標為我軍，則受擊傷害降低 30%（受智力影響）；若目標為敵軍，則使其造成的傷害降低 30%（受智力影響），持續 1 回合。",
    specialEquip: "汗血寶馬",
    specialFeature: "鐵陣",
    specialFeatureDesc: "徐彥裝備時，戰鬥中我軍全體獲得『嚴密』狀態（抵禦可疊加）。",
    equipBonus: "統率 +5.00, 智力 +5.00",
    analysis: "防禦能力拉滿。超高的 70% 主動發動機率，利用無死角的多重抵禦與減傷控場，能以最輕微的損兵代價，刷滿戰功！",
    recommendedTeams: [
      "【盾兵】張角 + 徐彥 + 左慈 (多重抵禦循環，配合張角天公五雷轟頂雷擊群控)"
    ],
    recommendedClass: "諸葛亮、曹操、司馬懿",
  ...
  },
  {
    ...
    specialEquip: "赤血刀",
    specialFeature: "遞機",
    specialFeatureDesc: "沈姮裝備時，自帶戰法【風始相形】機率判定改為受自身最高屬性影響。",
    equipBonus: "武力 +5.00, 速度 +5.00",
    analysis: "多重無限套娃連發流！發動主動或突擊戰法有巨大機率當場重播，直接將單回合爆發提升 100%。強力推薦配合多主動突擊將領。",
    recommendedTeams: [
      "【騎兵】SP荀彧 + SP郭嘉 + 沈姮 (沈姮高速高頻觸發，持續激活 SP 郭嘉的『經天緯地』機制的恐怖傷害)"
    ],
    recommendedClass: "SP郭嘉、郭嘉",
  ...
  },
  {
    ...
    skillName: "技高一籌",
    skillRate: "100%",
    skillDescription: "戰鬥中，敵軍全體發動主動戰法時，我軍智力最高武將有70%機率（受其智力影響）對其造成一次謀略傷害（傷害率128%）；發動突擊戰法時，我軍武力最高武將有70%機率（受其武力影響）對其造成一次兵刃傷害（傷害率128%）。",
    specialEquip: "白龍",
    specialFeature: "洞玄",
    specialFeatureDesc: "蘇信裝備時，自帶戰法【技高一籌】反制傷害率提升 10%。",
    equipBonus: "武力 +5.00, 統率 +5.00",
    analysis: "天生的戰法反制回響器。不論敵方使出魔法還是菜刀，只要發動戰法就會激發我軍主力的物理/法術巨量反噬。極致防守反擊戰術。",
    recommendedTeams: [
      "【弓兵】周瑜 + 蘇信 + 呂蒙 (精準補充反擊傷害，配合呂蒙的控場限制敵方發揮)"
    ],
    recommendedClass: "周瑜、諸葛亮、司馬懿",
  ...
  },
  {
    ...
    skillName: "運籌帷幄",
    skillRate: "100%",
    skillDescription: "戰鬥前 3 回合，友軍群體（2人）受到傷害降低 20%（受智力影響），並獲得急救狀態：受傷時有 35% 機率（受我軍全體智力之和影響）獲得治療（治療率 50%，受智力影響）。",
    specialEquip: "銀龍甲",
    specialFeature: "磐石",
    specialFeatureDesc: "馬嬋裝備時，自帶戰法的保護減傷及急救目標改為【我軍全體】。",
    equipBonus: "武力 +5.00, 智力 +5.00",
    analysis: "前3回合為友軍提供減傷和治療，有效抵禦各類速攻隊伍陣容（如三勢呂、吳騎、爆頭騎）時是絕對的歎息之牆。拜師推薦法系核心。",
    recommendedTeams: [
      "【騎兵】姜維 + 關銀屏 + 馬嬋 (提供前期傷害減益，拖延戰局到中後期陣型爆發)",
      "【騎兵】孫權 + 周泰 + 馬嬋 (配合急救保護為孫權暖機)"
    ],
    recommendedClass: "郭嘉、諸葛亮、司馬懿",
  ...
  },
  {
    ...
    skillName: "針鋒相對",
    skillRate: "100%",
    skillDescription: "戰鬥中，自身無法造成傷害；第2回合起，友軍單體受到普通攻擊後，有 40% 機率（受其統率影響）發動一次反擊（傷害率 70% ，可觸發普通攻擊類效果）。",
    specialEquip: "呂氏鏡",
    specialFeature: "決守",
    specialFeatureDesc: "陳熙裝備時，針鋒相對必定選擇統率最高的友軍。",
    equipBonus: "統率 +5.00, 速度 +5.00",
    analysis: "特異型物理協戰都尉。雖然不能親自動手，但能把隊友武將（如呂布、SP關羽、張飛）變成自帶強烈反擊突擊傷害的怪物。在專屬特技配合下有極高戰術套路空間。",
    recommendedTeams: [
      "【弓兵】陳熙 + 呂布 + 許攸 (陳熙獲得專屬特技裝備後，可穩定讓呂布觸發反擊，提高摧鋒斷刃、當鋒摧決的發動次數)"
    ],
    recommendedClass: "戰法受統率影響，可選擇諸葛亮、周瑜、曹操",
  ...
  },
  {
    ...
    skillName: "先聲奪人",
    skillRate: "55%",
    skillDescription: "偷取敵軍武力最高武將 20 武力和速度（受武力最高友軍的武力影響）賦予我軍武力最高武將，偷取敵軍智力最高武將 20 智力和統率（受智力最高友軍的智力影響）賦予我軍智力最高武將，可疊加，持續 2 回合。",
    specialEquip: "大葉青銅甲",
    specialFeature: "星移",
    specialFeatureDesc: "秦溪裝備時，【先聲奪人】的偷取效果持續時間從 2 回合改為 3 回合",
    equipBonus: "統率 +5.00, 智力 +5.00",
    analysis: "完美的屬性偷取跟轉化戰術。能夠偷取對手智力或武力，並全額賦予我方主力。",
    recommendedTeams: [
      "【騎兵】SP荀彧 + 秦溪 + SP郭嘉 (泰溪偷取敵軍屬性，配合SP郭嘉的奪魂挾魄，形成較大的屬性差距，加大輸出傷害)"
    ],
    recommendedClass: "曹操、諸葛亮、周瑜",
...
export const TALENTS: Talent[] = [
  ...
  // 屬性與特殊
  { name: "身經百戰", effect: "自身統禦提升1，四項戰鬥屬性提升5%", cost: 8 },
  { name: "天賦昇稟", effect: "自身進階等級自由 +1 (多額外 10 點自由加點屬性及減傷)", cost: 10 },
  { name: "融會貫通", effect: "戰鬥中，自身謀略奇謀機率與物理會心幾率平衡至兩者之間的最高數值", cost: 8 },
  { name: "軍令如山", effect: "戰鬥中，自身永久獲得「嚴密」狀態（抵禦次數可疊加）", cost: 6 },
  { name: "生生不息", effect: "戰鬥中，自身造成及承受的治療總量提升 5%", cost: 3 },
  // 特定戰法特技
  { name: "濟危定軍", effect: "自身攜帶兵種或陣法【武鋒陣】時，武鋒陣戰鬥治療目標改為我軍兵力最低的單體", cost: 6 },
  { name: "旌旗蔽日", effect: "自身攜帶【錦帆軍】時，錦帆軍觸發機率提升至 55%", cost: 10 },
  { name: "百計迭出", effect: "自身攜帶【奇計良謀】時，奇計良謀全場降低敵軍傷害特效時長延長至 6 回合", cost: 5 },
  { name: "挫銳分勢", effect: "自身攜帶【挫銳】時，挫銳目標改為敵軍群體（2人）", cost: 6 },
  { name: "陣走龍蛇", effect: "自身攜帶【箕形陣】時，受到傷害降低效果的日標改為我軍全體", cost: 9 },
  // 團隊行軍與戰略
  { name: "得道多助", effect: "所在部隊駐守戰鬥時，每名武將獲得 300 鄉勇 （部隊兵力＞最大可攜帶兵力 65% 時生效）", cost: 6 },
  { name: "勇往直前", effect: "所在部隊在敵方建築上發生戰鬥時，造成傷害提高 5%", cost: 4 },
  { name: "聞雞起舞", effect: "所在部隊現實時間 08-10 點造成傷害提高 5%；現實時間 22-24 點造成傷害降低 5%", cost: 2 },
  { name: "馬革裹屍", effect: "本都尉部隊戰損兵死比例降低 8%（戰後可重傷動員返還更多兵力）", cost: 12 },
  { name: "狹路相逢", effect: "本都尉部隊戰鬥時「無視兵種相克」（即雙方不互相克制，消除負面克制減益）", cost: 15 },
  { name: "簞醪投川", effect: "所在部隊被玩家部隊擊敗時，返還 10% 陣亡兵力的徵兵資源", cost: 4 },
  { name: "民心所望", effect: "在中立玩家營地、高級碼頭、城池內征兵時，不消耗銅幣", cost: 1 },
  { name: "迎難而上", effect: "所在部隊和進階數不低於自身的玩家部隊戰鬥後，額外獲得 5%（敵軍每多 1 階 +2% ）戰功", cost: 10 },
...
export const NEW_HEROES = {
  ...
  eventTactic: {
    name: "深藏若虛",
    type: "被動戰法 (100% 觸發)",
    exchange: "需要 4 個武將（吴•周瑜/吴•甘宁/ 魏•曹仁/吴•周泰/吴•程普）進行事件兌換。",
